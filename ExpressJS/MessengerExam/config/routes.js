...
module.exports = app => {
  ...
  app.post('/thread/:username', auth.isAuthed, auth.isNotBlocked, controllers.thread.chatRoom.post)
  ...
  app.get('/message/:messageId/like', auth.isAuthed, controllers.message.like)
  app.get('/message/:messageId/unlike', auth.isAuthed, controllers.message.unlike)
  app.all('*', (req, res) => {
    res.status(404)
