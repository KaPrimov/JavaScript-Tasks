function cityMarkets(sales) {
    ...
    for (let [key, mapValues] of townsWithProducts){
    ...
    cityMarkets(['Sofia -> Laptops HP -> 200 : 2000', 'Sofia -> Raspberry -> 200000 : 1500', 'Montana -> Qgodas -> 20000 : 0.2', 'Montana -> Chereshas -> 1000 : 0.3']);